Edited dockerfile to build static and use scratch image for a smaller container(4 mb).  Using local storage or S3(Minio) behind a proxy works without issues.  Not tested beyond that.
